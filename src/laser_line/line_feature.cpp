...
namespace line_feature
{
	...
	void LineFeature::setRangeData(const std::vector<double> &ranges)
	{
		...
		// std::cout<<"================"<<cs_data_.index.size()<<std::endl;;
		// for (int i=0; i<range_data_.ranges.size(); i++ )
		// {
		// 	if(range_data_.ranges[i] > 20.0)
		// 		range_data_.ranges[i] = 0.0;
		// 	std::cout<<" "<< range_data_.ranges[i] ;
		// }
		// std::cout<<"================"<<std::endl;;		
